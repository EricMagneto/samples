...
namespace FlightFinder.Server
{
    public class SampleData
    {
        ...
        public readonly static Dictionary<RentalCarKind, string[]> RentalCars = new Dictionary<RentalCarKind, string[]>()
        {
            {
                RentalCarKind.Economy,
                new string[]
                {
                    "Ford Focus",
                    "Toyota Corolla",
            ...
            {
                RentalCarKind.Sedan, new string[]
                {
                    "Buick Lacrosse",
                    "Ford Taurus",
                    "Honda Accord",
